...
namespace produccion.Data.Migrations
{
    ...
    [Migration("20231102213046_InitialCreateMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("produccion.Entities.DetalleVentum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("produccion.Entities.Pai", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("produccion.Entities.Prendum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("produccion.Entities.Ventum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("produccion.Entities.Departamento", b =>
                {
                    b.HasOne("produccion.Entities.Pai", "IdPaisFkNavigation")
            ...
            modelBuilder.Entity("produccion.Entities.DetalleOrden", b =>
                {
                    ...
                    b.HasOne("produccion.Entities.Prendum", "Prenda")
                        .WithMany("DetalleOrdens")
            ...
            modelBuilder.Entity("produccion.Entities.DetalleVentum", b =>
                {
                    ...
                    b.HasOne("produccion.Entities.Ventum", "IdVentaFkNavigation")
                        .WithMany("DetalleVenta")
            ...
            modelBuilder.Entity("produccion.Entities.InsumoPrenda", b =>
                {
                    ...
                    b.HasOne("produccion.Entities.Prendum", "IdPrendaFkNavigation")
                        .WithMany("InsumoPrenda")
